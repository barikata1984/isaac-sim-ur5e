...
# Mocking MISSING if omegaconf is not available, 
# although the environment likely has it if it was in the reference.
try:
...
class BaseTrajectory(ABC):
    ...
    def write_to_json(self, pos, vel, acc, json_path="trajectory.json"):
        frames = []
